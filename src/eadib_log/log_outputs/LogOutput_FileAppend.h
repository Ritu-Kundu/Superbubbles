...
namespace eadlib {
    namespace log {
         ...
         * Destructor
         */
        eadlib::log::LogOutput_FileAppend::~LogOutput_FileAppend() {
            if( _output_stream ) {
                close_ostream();
            }
        }
         ...
         */
        void eadlib::log::LogOutput_FileAppend::open_ostream( const std::string &file_name ) {
         ...
         */
        void eadlib::log::LogOutput_FileAppend::close_ostream() {
            if( _output_stream ) {
         ...
         */
        void eadlib::log::LogOutput_FileAppend::write( const std::string &msg ) {
