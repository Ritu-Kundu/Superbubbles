...
namespace eadlib {
    namespace log {
         ...
         * Destructor
         */
        eadlib::log::LogOutput_FileOverwrite::~LogOutput_FileOverwrite() {
            if( _output_stream ) {
                close_ostream();
            }
        }
         ...
         */
        void eadlib::log::LogOutput_FileOverwrite::open_ostream( const std::string &file_name ) {
         ...
         */
        void eadlib::log::LogOutput_FileOverwrite::close_ostream() {
            if( _output_stream ) {
                close_ostream();
            }
        }
         ...
         */
        void eadlib::log::LogOutput_FileOverwrite::write( const std::string &msg ) {
